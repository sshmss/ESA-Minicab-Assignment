...
<html lang="en">
  <head>
    ...
    <body>
        <div id="login">
            <h2 class="text-center text-warning pt-5 logo">MINIC<span class="material-icons-outlined text-warning">local_taxi</span>B
            </h2>
                    ...
                    <div id="login-column" class="col-md-6">
                        <div id="login-box" class="col-md-12">
                            <form id="login-form" class="form" action="register" method="post">
                                ...
                                <div class="form-group">
                                    <label for="confirmPassword" class="text-light">Confirm Password</label><br>
                                    <input type="password" name="confirmPassword" id="confirmPassword" class="form-control">
                                </div>
                                <div class="row mt-4">
                                    <div class="col d-flex justify-content-end">
                                        <input type="submit" name="register" class="btn btn-warning btn-lg" value="Register">
                                    </div>
                                </div>
                            </form>
                        </div>
